...
export class Backend implements backendInterface {
    ...
    async createItem(arg0: string, arg1: bigint, arg2: string, arg3: bigint, arg4: boolean): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateItem(arg0: bigint, arg1: string, arg2: bigint, arg3: string, arg4: bigint, arg5: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateItem(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
